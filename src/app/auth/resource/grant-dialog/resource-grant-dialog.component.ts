...
export class ResourceGrantDialogComponent extends ComponentDialog<ResourceGrantDialogComponent, Resource, ResourceService>
  ...
  constructor(dialogRef: MdDialogRef<ResourceGrantDialogComponent>, private resourceService: ResourceService) {
    super(dialogRef);
  }
  ...
  private refreshTreeData(id: number): void {
    ...
    this.resourceService.getPermissionWithResource(id).subscribe(
      result => {
        let resourceRecords: Permission[] = result.data.sourceList;
        this.sourceTree = ResourceGrantDialogComponent.refreshTreeNode(resourceRecords);
        this.targetTree = ResourceGrantDialogComponent.refreshTreeNode(resourceRecords);
  ...
  private doGrant(): Observable<ResponseResult> {
    ...
    return this.resourceService.editPermissionWithResource(roleId, ids);
